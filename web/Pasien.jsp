<%-- 
    Document   : Pasien
    Created on : Apr 27, 2024, 10:20:17 AM
...
<div id="content">
    ...
    <br>
    <table border="1" width="100%" cellingpading="0" cellspacing="0">
        <tr class="head">
        ...
        <c:forEach var="rowpasien" items="${querypasien.rowByIndex}">
            <tr class="isi">
                ...
                <td>
                    <a href='sedPasien?aksi=HAPUS&no_klinik=${rowpasien[0]}'> Hapus</a> |
                    <a href='Beranda.jsp?halaman=Pasien&aksi=GANTI&no_klinik=${rowpasien[0]}&nm_pasien=${rowpasien[1]}&alm_pasien=${rowpasien[2]}
                        &jk=${rowpasien[3]}&tgl_lahir=${rowpasien[4]}&no_telp=${rowpasien[5]}&umur=${rowpasien[6]}'> Edit </a>
                </td>
            </tr>
        </c:forEach>
    </table>
