<%-- 
    Document   : Obat
    Created on : Apr 27, 2024, 9:45:07 AM
...
<div id="content">
        ...
        <tr>
            <td valign='top'>
                <form action="sedObat" method="post">
                    ...
                    <tr>
                        <td>Kode Obat</td> <td>: <input type="text" name="kd_obat" value="$kd_obat"{param.kd_obat}"/></td>
                    </tr>
                    <tr>
    ...
    <table border="1" width="70%" cellpading="0" cellspacing="0">
        ...
        <c:forEach var="rowobat" items="${queryobat.rowsByIndex}">
            <tr class="isi">
                <td valig='top'>${rowobat[0]}</td>
                <td valig='top'>${rowobat[1]}</td>
                <td valig='top'>${rowobat[2]}</td>
                <td valig='top'>
                    <a href='sedObat?aksi=HAPUS&kd_obat=${rowobat[0]}'> Hapus</a> |
