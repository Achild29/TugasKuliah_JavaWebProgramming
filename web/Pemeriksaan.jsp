<%-- 
    ...
    Created on : May 20, 2024, 12:23:49 AM
                ...
                <form action="sedPemeriksaan" method="post">
                    ...
                    <tr>
                        <td>Nama Dokter</td><td>:
                            <select name="nip">
                                <sql:query var="querypertugas" dataSource="${dataSource}">
        ...
        <c:forEach var="rowpemeriksaan" items="${querypemeriksaan.rowsByIndex}">
            <tr class="isi">
                ...
                <td valign='top'><a href='sedPemeriksaan?aksi=HAPUS&no_rawat=${rowpemeriksaan[0]}'>Hapus</a> |
                    <a href='Beranda.jsp?halaman=Pemeriksaan$aksi=GANTI&no_rawat=${rowpemeriksaan[0]}&no_klinik=${rowpemeriksaan[1]}
                       &nip=${rowpemeriksaan[2]}&kd_obat=${rowpemeriksaan[3]}&diagnosa=${rowpemeriksaan[4]}&brt_badan=${rowpemeriksaan[5]}
                       $tensi=${rowpemeriksaan[6]}&suhu_tubuh=${rowpemeriksaan[7]}&ket=${rowpemeriksaan[8]}'> Edit </a>
                </td>
            </tr>
        </c:forEach>
    </table>
                <br>
                <a href="reportPemeriksaan.jsp?exportToExcel=YES" width="5%" class="buttonlap">Lapooran Excel</a> <br>
                <br>
</div>